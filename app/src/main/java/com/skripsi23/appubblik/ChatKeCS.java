...
public class ChatKeCS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_ke_cs);
        ...
        //getActionBar().setTitle("CS : "+namaLayanan);

        Kref = new Firebase("https://appubblik-9c8ec.firebaseio.com/").child("chat").child(to_id);
        txtLayanan = (TextView) findViewById(R.id.txtLayanan);
        txtLayanan.setText("CS : "+ namaLayanan);
